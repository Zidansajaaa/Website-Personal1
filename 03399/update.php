...
<body>
    ...
    <div class="col-md-6 offset-md-3 align-self-center"> 
      ...
      <form method="POST">
        ...
        <div class="mb-3">
          ...
          <input type="number" class="form-control" id="inputNim" value="<?= $data['Nim'] ?>" name="Nim" placeholder="Masukan Nim Siswa">
        </div>
        <div class="mb-3">
  ...
  <?php
    ...
    if(isset($_POST['daftar'])){
      ...
      // Membuat Query
      $query = "UPDATE tb_siswa SET Nim = '$Nim', nama = '$nama', kelas = '$kelas' WHERE id = '$id'";
